...
meta() %>%
  ...
  meta_social(
    ...
    url = "https://r-ladies-sao-paulo.github.io/2020-hacktoberfest/slides/rladies/index.html",
    image = "https://r-ladies-sao-paulo.github.io/2020-hacktoberfest/slides/rladies/img/share-card.png",
    image_alt = paste(
...
A R-Ladies dedica-se a proporcionar uma experiência livre de assédio para todas as pessoas partcicipantes, desta forma, não é tolerada nenhuma forma de assédio. [Código de conduta - R-Ladies](https://github.com/rladies/.github/blob/master/CODE_OF_CONDUCT.md#portuguese)
